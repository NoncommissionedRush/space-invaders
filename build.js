(() => {
  ...
  var Et = (e, t, r) => t in e ? Gt(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
  var ne = (e, t) => {
    for (var r in t || (t = {}))
  ...
  var ie = (e, t) => xn(e, wn(t));
  var s = (e, t) => Gt(e, "name", { value: t, configurable: true });
  var ae = (e, t) => () => (e && (t = e(e = 0)), t);
  var Bn = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports);
  var Zt = (e, t, r) => (Et(e, typeof t != "symbol" ? t + "" : t, r), r);
  var Jt = (e, t, r) => new Promise((u, b) => {
    var B = (D) => {
      try {
        T(r.next(D));
      } catch (z) {
    ...
    }, T = (D) => D.done ? u(D.value) : Promise.resolve(D.value).then(B, v);
...
`));
  ...
  function restoreShield(player) {
    debug.log("SHIELD RESTORED TO 100%");
    player.shield = 100;
  }
  function unlimitedLasers(player) {
  ...
  function freezeInvaders(settings, timeLimit = 10) {
  ...
  // scenes/game.js
  function Game(score2 = 0, level = 1, shield = 100) {
    let gameScore = score2;
    let gameLevel = level;
    let SETTINGS = {
      rocketSpeed: 300,
    ...
    collides("invader-laser", "shield", (laser, shield2) => {
      shield2.life -= 1;
      shield2.opacity = shield2.life / 10;
      shake(4);
      explode(laser);
      if (shield2.life === 0) {
        destroy(shield2);
    ...
    collides("meteor", "shield", (meteor, shield2) => {
      shield2.life -= 5;
      shield2.opacity = shield2.life / 10;
      shake(5);
      explode(meteor);
    ...
    collides("invader-laser", "rocket", (laser, rocket2) => {
      shake(4);
      explode(laser);
      rocket2.shield -= 10;
      shieldBar.width = rocket2.shield;
      if (rocket2.shield < 0) {
        go("gameover", gameScore);
      }
    });
    collides("meteor", "rocket", (meteor, rocket2) => {
      shake(5);
      explode(meteor);
      rocket2.shield -= 50;
      shieldBar.width = rocket2.shield;
  ...
  // scenes/gameover.js
  function GameOver(score2) {
    add([
      text(`Game Over! Score: ${score2}`, { font: "sink", size: 60 }),
      origin("center"),
